...
test_that("outputs are lists with two components: (1) total run time and (2) dataframe", {
  ...
  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_tree")), "list")
  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_tree")$run_time), "difftime")
  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe), "data.frame")

  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_plot")), "list")
  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_plot")$run_time), "difftime")
  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_plot")$dataframe), "data.frame")

  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_species")), "list")
  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_species")$run_time), "difftime")
  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_species")$dataframe), "data.frame")

  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_status")), "list")
  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_status")$run_time), "difftime")
  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_status")$dataframe), "data.frame")

  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_sp_st")), "list")
  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_sp_st")$run_time), "difftime")
  expect_equal(class(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_sp_st")$dataframe), "data.frame")
...
test_that("by_tree dataframes have expected column names", {
  ...
  expect_named(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "imperial", results = "by_tree")$dataframe,
  ...
  expect_named(BiomassNSVB(data = nsvb_gi, input_units = "imperial", output_units = "metric", results = "by_tree")$dataframe,
               c("division", "province", "site", "plot", "exp_factor", "status", "decay_class", "species", "dbh_cm", "ht1_m", "ht2_m", "crown_ratio",
                 "top", "cull", "total_wood_kg", "total_bark_kg", "total_branch_kg", "total_ag_kg", "merch_wood_kg", "merch_bark_kg", "merch_total_kg",
                 "merch_top_kg", "stump_wood_kg", "stump_bark_kg", "stump_total_kg", "foliage_kg", "total_wood_c", "total_bark_c", "total_branch_c", "total_ag_c",
                 "merch_wood_c", "merch_bark_c", "merch_total_c", "merch_top_c", "stump_wood_c", "stump_bark_c", "stump_total_c", "foliage_c", "calc_bio"))

  expect_named(BiomassNSVB(data = nsvb_gi, input_units = "imperial", output_units = "imperial", results = "by_tree")$dataframe,
               c("division", "province", "site", "plot", "exp_factor", "status", "decay_class", "species", "dbh_in", "ht1_ft", "ht2_ft", "crown_ratio", "top", "cull",
                 "total_wood_tons", "total_bark_tons", "total_branch_tons", "total_ag_tons", "merch_wood_tons", "merch_bark_tons", "merch_total_tons", "merch_top_tons",
                 "stump_wood_tons", "stump_bark_tons", "stump_total_tons", "foliage_tons", "total_wood_c", "total_bark_c", "total_branch_c", "total_ag_c", "merch_wood_c",
...
test_that("by_tree dataframes have expected column classes", {
  ...
  by_tree_check1 <- BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "imperial", results = "by_tree")$dataframe
  ...
  # Outputs are metric ---------------------------------------------------------
  by_tree_check2 <- BiomassNSVB(data = nsvb_gi, input_units = "imperial", output_units = "metric", results = "by_tree")$dataframe
...
test_that("NA biomass/carbon is as expected", {
  ...
  NA_check_small <- subset(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe, dbh_cm < 12.7,
  ...
  expect_warning(NA_check_status <- BiomassNSVB(data = nsvb_b28, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe)
  expect_true(all(is.na(subset(NA_check_status, exp_factor > 0 & is.na(status),
                        select = -c(division, province, site, plot, exp_factor, status, decay_class, species, dbh_cm, ht1_m, ht2_m, crown_ratio, top, cull, calc_bio)))))

  # trees with NA species have NA estimates
  expect_warning(NA_check_sp <- BiomassNSVB(data = nsvb_b38, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe)
  expect_true(all(is.na(subset(NA_check_sp, exp_factor > 0 & is.na(species),
                        select = -c(division, province, site, plot, exp_factor, status, decay_class, species, dbh_cm, ht1_m, ht2_m, crown_ratio, top, cull, calc_bio)))))

  # trees with NA dbh have NA estimates
  expect_warning(NA_check_dbh1 <- BiomassNSVB(data = nsvb_b41, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe)
  ...
  expect_warning(NA_check_dbh2 <- BiomassNSVB(data = nsvb_b42, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe)
  expect_true(all(is.na(subset(NA_check_dbh2, dbh_cm < 2.5,
                        select = -c(division, province, site, plot, exp_factor, status, decay_class, species, dbh_cm, ht1_m, ht2_m, crown_ratio, top, cull, calc_bio)))))

  # trees with dbh below cutoff (in imperial) have NA estimates
  expect_warning(NA_check_dbh3 <- BiomassNSVB(data = nsvb_b43, input_units = "imperial", output_units = "imperial", results = "by_tree")$dataframe)
  ...
  expect_warning(NA_check_ht1.1 <- BiomassNSVB(data = nsvb_b44, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe)
  ...
  expect_warning(NA_check_ht1.2 <- BiomassNSVB(data = nsvb_b46, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe)
  expect_true(all(is.na(subset(NA_check_ht1.2, ht1_m < 1.37,
                        select = -c(division, province, site, plot, exp_factor, status, decay_class, species, dbh_cm, ht1_m, ht2_m, crown_ratio, top, cull, calc_bio)))))

  # trees with ht1 below cutoff (in imperial) have NA estimates
  expect_warning(NA_check_ht1.3 <- BiomassNSVB(data = nsvb_b48, input_units = "imperial", output_units = "imperial", results = "by_tree")$dataframe)
  expect_true(all(is.na(subset(NA_check_ht1.3, ht1_ft < 4.5,
                        select = -c(division, province, site, plot, exp_factor, status, decay_class, species, dbh_in, ht1_ft, ht2_ft, crown_ratio, top, cull, calc_bio)))))

  # trees with NA ht2 have NA estimates
  expect_warning(NA_check_ht2.1 <- BiomassNSVB(data = nsvb_b45, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe)
  ...
  expect_warning(NA_check_ht2.2 <- BiomassNSVB(data = nsvb_b47, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe)
  expect_true(all(is.na(subset(NA_check_ht2.2, ht2_m < 1.37,
                        select = -c(division, province, site, plot, exp_factor, status, decay_class, species, dbh_cm, ht1_m, ht2_m, crown_ratio, top, cull, calc_bio)))))

  # trees with ht2 below cutoff (in imperial) have NA estimates
  expect_warning(NA_check_ht2.3 <- BiomassNSVB(data = nsvb_b49, input_units = "imperial", output_units = "imperial", results = "by_tree")$dataframe)
...
test_that("Units are being converted properly", {
  ...
  # dbh conversions
  expect_equal(BiomassNSVB(data = nsvb_m_units, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe$dbh_cm, nsvb_m_units$dbh)
  expect_equal(BiomassNSVB(data = nsvb_m_units, input_units = "metric", output_units = "imperial", results = "by_tree")$dataframe$dbh_in, nsvb_i_units$dbh)
  expect_equal(BiomassNSVB(data = nsvb_i_units, input_units = "imperial", output_units = "imperial", results = "by_tree")$dataframe$dbh_in, nsvb_i_units$dbh)
  expect_equal(BiomassNSVB(data = nsvb_i_units, input_units = "imperial", output_units = "metric", results = "by_tree")$dataframe$dbh_cm, nsvb_m_units$dbh)

  # ht1 conversions
  expect_equal(BiomassNSVB(data = nsvb_m_units, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe$ht1_m, nsvb_m_units$ht1)
  expect_equal(BiomassNSVB(data = nsvb_m_units, input_units = "metric", output_units = "imperial", results = "by_tree")$dataframe$ht1_ft, nsvb_i_units$ht1)
  expect_equal(BiomassNSVB(data = nsvb_i_units, input_units = "imperial", output_units = "imperial", results = "by_tree")$dataframe$ht1_ft, nsvb_i_units$ht1)
  expect_equal(BiomassNSVB(data = nsvb_i_units, input_units = "imperial", output_units = "metric", results = "by_tree")$dataframe$ht1_m, nsvb_m_units$ht1)

  # ht2 conversions
  expect_equal(BiomassNSVB(data = nsvb_m_units, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe$ht2_m, nsvb_m_units$ht2)
  expect_equal(BiomassNSVB(data = nsvb_m_units, input_units = "metric", output_units = "imperial", results = "by_tree")$dataframe$ht2_ft, nsvb_i_units$ht2)
  expect_equal(BiomassNSVB(data = nsvb_i_units, input_units = "imperial", output_units = "imperial", results = "by_tree")$dataframe$ht2_ft, nsvb_i_units$ht2)
  expect_equal(BiomassNSVB(data = nsvb_i_units, input_units = "imperial", output_units = "metric", results = "by_tree")$dataframe$ht2_m, nsvb_m_units$ht2)

  # exp_factor conversions
  expect_equal(BiomassNSVB(data = nsvb_m_units, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe$exp_factor, nsvb_m_units$exp_factor)
  expect_equal(round(BiomassNSVB(data = nsvb_m_units, input_units = "metric", output_units = "imperial", results = "by_tree")$dataframe$exp_factor,5), nsvb_i_units$exp_factor)
  expect_equal(BiomassNSVB(data = nsvb_i_units, input_units = "imperial", output_units = "imperial", results = "by_tree")$dataframe$exp_factor, nsvb_i_units$exp_factor)
  expect_equal(round(BiomassNSVB(data = nsvb_i_units, input_units = "imperial", output_units = "metric", results = "by_tree")$dataframe$exp_factor,0), nsvb_m_units$exp_factor)

  # biomass estimates should be the same regardless of input units
  expect_equal(BiomassNSVB(data = nsvb_m_units, input_units = "metric", output_units = "metric", results = "by_tree")$dataframe$total_wood_kg,
               BiomassNSVB(data = nsvb_i_units, input_units = "imperial", output_units = "metric", results = "by_tree")$dataframe$total_wood_kg)

  expect_equal(BiomassNSVB(data = nsvb_m_units, input_units = "metric", output_units = "imperial", results = "by_tree")$dataframe$total_wood_tons,
               BiomassNSVB(data = nsvb_i_units, input_units = "imperial", output_units = "imperial", results = "by_tree")$dataframe$total_wood_tons)
...
test_that("by_sp_st dataframes have expected column names", {
  ...
  expect_named(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "imperial", results = "by_sp_st")$dataframe,
  ...
  expect_named(BiomassNSVB(data = nsvb_gi, input_units = "imperial", output_units = "metric", results = "by_sp_st")$dataframe,
...
test_that("by_sp_st dataframes have expected column classes", {
  ...
  # Outputs are imperial -------------------------------------------------------
  by_sp_st_check1 <- BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "imperial", results = "by_sp_st")$dataframe
  ...
  # Outputs are metric ---------------------------------------------------------
  by_sp_st_check2 <- BiomassNSVB(data = nsvb_gi, input_units = "imperial", output_units = "metric", results = "by_sp_st")$dataframe
...
test_that("by_species dataframes have expected column names", {
  ...
  expect_named(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "imperial", results = "by_species")$dataframe,
               c("site", "plot", "species",
  ...
  expect_named(BiomassNSVB(data = nsvb_gi, input_units = "imperial", output_units = "metric", results = "by_species")$dataframe,
               c("site", "plot", "species",
...
test_that("by_species dataframes have expected column classes", {
  ...
  # Outputs are imperial -------------------------------------------------------
  by_sp_check1 <- BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "imperial", results = "by_species")$dataframe
  ...
  # Outputs are metric ---------------------------------------------------------
  by_sp_check2 <- BiomassNSVB(data = nsvb_gi, input_units = "imperial", output_units = "metric", results = "by_species")$dataframe
...
test_that("by_status dataframes have expected column names", {
  ...
  expect_named(BiomassNSVB(data = nsvb_gm,input_units = "metric", output_units = "imperial", results = "by_status")$dataframe,
  ...
  expect_named(BiomassNSVB(data = nsvb_gi, input_units = "imperial", output_units = "metric", results = "by_status")$dataframe,
...
test_that("by_status dataframes have expected column classes", {
  ...
  # Outputs are imperial -------------------------------------------------------
  by_st_check1 <- BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "imperial", results = "by_status")$dataframe
  ...
  # Outputs are metric ---------------------------------------------------------
  by_st_check2 <- BiomassNSVB(data = nsvb_gi, input_units = "imperial", output_units = "metric", results = "by_status")$dataframe
...
test_that("by_plot dataframes have expected column names", {
  ...
  expect_named(BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "imperial", results = "by_plot")$dataframe,
  ...
  expect_named(BiomassNSVB(data = nsvb_gi, input_units = "imperial", output_units = "metric", results = "by_plot")$dataframe,
...
test_that("by_plot dataframes have expected column classes", {
  ...
  # Outputs are imperial -------------------------------------------------------
  by_plot_check1 <- BiomassNSVB(data = nsvb_gm, input_units = "metric", output_units = "imperial", results = "by_plot")$dataframe
  ...
  # Outputs are metric ---------------------------------------------------------
  by_plot_check2 <- BiomassNSVB(data = nsvb_gi, input_units = "imperial", output_units = "metric", results = "by_plot")$dataframe
...
test_that("Package and GTR example calculations match", {
  ...
  nsvb_package <- BiomassNSVB(data = gtr_examples, input_units = "imperial", output_units = "imperial", results = "by_tree")$dataframe
  ...
  # Example 1
  expect_equal(nsvb_package_1$total_wood_tons, nsvb_hand_1$total_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_1$total_bark_tons, nsvb_hand_1$total_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_1$total_branch_tons, nsvb_hand_1$total_branch_tons, tolerance=1e-3)
  expect_equal(nsvb_package_1$total_ag_tons, nsvb_hand_1$total_ag_tons, tolerance=1e-3)
  expect_equal(nsvb_package_1$merch_wood_tons, nsvb_hand_1$merch_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_1$merch_bark_tons, nsvb_hand_1$merch_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_1$merch_total_tons, nsvb_hand_1$merch_total_tons, tolerance=1e-3)
  expect_equal(nsvb_package_1$merch_top_tons, nsvb_hand_1$merch_top_tons, tolerance=1e-3)
  expect_equal(nsvb_package_1$stump_wood_tons, nsvb_hand_1$stump_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_1$stump_bark_tons, nsvb_hand_1$stump_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_1$stump_total_tons, nsvb_hand_1$stump_total_tons, tolerance=1e-3)
  expect_equal(nsvb_package_1$foliage_tons, nsvb_hand_1$foliage_tons, tolerance=1e-3)
  expect_equal(nsvb_package_1$total_ag_c, nsvb_hand_1$total_ag_c_tons, tolerance=1e-3)

  # Example 2
  expect_equal(nsvb_package_2$total_wood_tons, nsvb_hand_2$total_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_2$total_bark_tons, nsvb_hand_2$total_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_2$total_branch_tons, nsvb_hand_2$total_branch_tons, tolerance=1e-3)
  expect_equal(nsvb_package_2$total_ag_tons, nsvb_hand_2$total_ag_tons, tolerance=1e-3)
  expect_equal(nsvb_package_2$merch_wood_tons, nsvb_hand_2$merch_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_2$merch_bark_tons, nsvb_hand_2$merch_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_2$merch_total_tons, nsvb_hand_2$merch_total_tons, tolerance=1e-3)
  expect_equal(nsvb_package_2$merch_top_tons, nsvb_hand_2$merch_top_tons, tolerance=1e-3)
  expect_equal(nsvb_package_2$stump_wood_tons, nsvb_hand_2$stump_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_2$stump_bark_tons, nsvb_hand_2$stump_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_2$stump_total_tons, nsvb_hand_2$stump_total_tons, tolerance=1e-3)
  expect_equal(nsvb_package_2$foliage_tons, nsvb_hand_2$foliage_tons, tolerance=1e-3)
  expect_equal(nsvb_package_2$total_ag_c, nsvb_hand_2$total_ag_c_tons, tolerance=1e-3)

  # Example 3
  expect_equal(nsvb_package_3$total_wood_tons, nsvb_hand_3$total_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_3$total_bark_tons, nsvb_hand_3$total_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_3$total_branch_tons, nsvb_hand_3$total_branch_tons, tolerance=1e-3)
  expect_equal(nsvb_package_3$total_ag_tons, nsvb_hand_3$total_ag_tons, tolerance=1e-3)
  expect_equal(nsvb_package_3$merch_wood_tons, nsvb_hand_3$merch_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_3$merch_bark_tons, nsvb_hand_3$merch_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_3$merch_total_tons, nsvb_hand_3$merch_total_tons, tolerance=1e-3)
  expect_equal(nsvb_package_3$merch_top_tons, nsvb_hand_3$merch_top_tons, tolerance=1e-3)
  expect_equal(nsvb_package_3$stump_wood_tons, nsvb_hand_3$stump_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_3$stump_bark_tons, nsvb_hand_3$stump_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_3$stump_total_tons, nsvb_hand_3$stump_total_tons, tolerance=1e-3)
  expect_equal(nsvb_package_3$foliage_tons, nsvb_hand_3$foliage_tons, tolerance=1e-3)
  expect_equal(nsvb_package_3$total_ag_c, nsvb_hand_3$total_ag_c_tons, tolerance=1e-3)

  # Example 4
  expect_equal(nsvb_package_4$total_wood_tons, nsvb_hand_4$total_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_4$total_bark_tons, nsvb_hand_4$total_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_4$total_branch_tons, nsvb_hand_4$total_branch_tons, tolerance=1e-3)
  expect_equal(nsvb_package_4$total_ag_tons, nsvb_hand_4$total_ag_tons, tolerance=1e-3)
  expect_equal(nsvb_package_4$merch_wood_tons, nsvb_hand_4$merch_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_4$merch_bark_tons, nsvb_hand_4$merch_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_4$merch_total_tons, nsvb_hand_4$merch_total_tons, tolerance=1e-3)
  expect_equal(nsvb_package_4$merch_top_tons, nsvb_hand_4$merch_top_tons, tolerance=1e-3)
  expect_equal(nsvb_package_4$stump_wood_tons, nsvb_hand_4$stump_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_4$stump_bark_tons, nsvb_hand_4$stump_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_4$stump_total_tons, nsvb_hand_4$stump_total_tons, tolerance=1e-3)
  expect_equal(nsvb_package_4$foliage_tons, nsvb_hand_4$foliage_tons, tolerance=1e-3)
  expect_equal(nsvb_package_4$total_ag_c, nsvb_hand_4$total_ag_c_tons, tolerance=1e-3)

  # Example 5
  expect_equal(nsvb_package_5$total_wood_tons, nsvb_hand_5$total_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_5$total_bark_tons, nsvb_hand_5$total_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_5$total_branch_tons, nsvb_hand_5$total_branch_tons, tolerance=1e-3)
  expect_equal(nsvb_package_5$total_ag_tons, nsvb_hand_5$total_ag_tons, tolerance=1e-3)
  expect_equal(nsvb_package_5$merch_wood_tons, nsvb_hand_5$merch_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_5$merch_bark_tons, nsvb_hand_5$merch_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_5$merch_total_tons, nsvb_hand_5$merch_total_tons, tolerance=1e-3)
  expect_equal(nsvb_package_5$merch_top_tons, nsvb_hand_5$merch_top_tons, tolerance=1e-3)
  expect_equal(nsvb_package_5$stump_wood_tons, nsvb_hand_5$stump_wood_tons, tolerance=1e-3)
  expect_equal(nsvb_package_5$stump_bark_tons, nsvb_hand_5$stump_bark_tons, tolerance=1e-3)
  expect_equal(nsvb_package_5$stump_total_tons, nsvb_hand_5$stump_total_tons, tolerance=1e-3)
  expect_equal(nsvb_package_5$foliage_tons, nsvb_hand_5$foliage_tons, tolerance=1e-3)
  expect_equal(nsvb_package_5$total_ag_c, nsvb_hand_5$total_ag_c_tons, tolerance=1e-3)
...
test_that("Package and hand species/status summaries match", {
  ...
  expect_warning(expect_warning(by_package_sp_st <- BiomassNSVB(data = nsvb_sum_check, input_units = "metric", output_units = "metric", results = "by_sp_st")$dataframe))
  ...
  expect_equal(by_package_sp_st$total_wood_L_Mg_ha, by_hand_sp_st$total_wood_L, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_wood_D_Mg_ha, by_hand_sp_st$total_wood_D, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_bark_L_Mg_ha, by_hand_sp_st$total_bark_L, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_bark_D_Mg_ha, by_hand_sp_st$total_bark_D, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_branch_L_Mg_ha, by_hand_sp_st$total_branch_L, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_branch_D_Mg_ha, by_hand_sp_st$total_branch_D, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_ag_L_Mg_ha, by_hand_sp_st$total_ag_L, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_ag_D_Mg_ha, by_hand_sp_st$total_ag_D, tolerance=1e-3)
  expect_equal(by_package_sp_st$merch_total_L_Mg_ha, by_hand_sp_st$merch_total_L, tolerance=1e-3)
  expect_equal(by_package_sp_st$merch_total_D_Mg_ha, by_hand_sp_st$merch_total_D, tolerance=1e-3)
  expect_equal(by_package_sp_st$merch_top_L_Mg_ha, by_hand_sp_st$merch_top_L, tolerance=1e-3)
  expect_equal(by_package_sp_st$merch_top_D_Mg_ha, by_hand_sp_st$merch_top_D, tolerance=1e-3)
  expect_equal(by_package_sp_st$stump_total_L_Mg_ha, by_hand_sp_st$stump_total_L, tolerance=1e-3)
  expect_equal(by_package_sp_st$stump_total_D_Mg_ha, by_hand_sp_st$stump_total_D, tolerance=1e-3)
  expect_equal(by_package_sp_st$foliage_L_Mg_ha, by_hand_sp_st$foliage_L, tolerance=1e-3)

  expect_equal(by_package_sp_st$total_wood_L_c, by_hand_sp_st$total_wood_L_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_wood_D_c, by_hand_sp_st$total_wood_D_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_bark_L_c, by_hand_sp_st$total_bark_L_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_bark_D_c, by_hand_sp_st$total_bark_D_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_branch_L_c, by_hand_sp_st$total_branch_L_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_branch_D_c, by_hand_sp_st$total_branch_D_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_ag_L_c, by_hand_sp_st$total_ag_L_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$total_ag_D_c, by_hand_sp_st$total_ag_D_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$merch_total_L_c, by_hand_sp_st$merch_total_L_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$merch_total_D_c, by_hand_sp_st$merch_total_D_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$merch_top_L_c, by_hand_sp_st$merch_top_L_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$merch_top_D_c, by_hand_sp_st$merch_top_D_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$stump_total_L_c, by_hand_sp_st$stump_total_L_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$stump_total_D_c, by_hand_sp_st$stump_total_D_c, tolerance=1e-3)
  expect_equal(by_package_sp_st$foliage_L_c, by_hand_sp_st$foliage_L_c, tolerance=1e-3)
...
test_that("Package and hand species summaries match", {
  ...
  expect_warning(expect_warning(by_package_sp <- BiomassNSVB(data = nsvb_sum_check, input_units = "metric", output_units = "metric", results = "by_species")$dataframe))
  ...
  expect_equal(by_package_sp$total_wood_Mg_ha, by_hand_sp$total_wood, tolerance=1e-3)
  expect_equal(by_package_sp$total_bark_Mg_ha, by_hand_sp$total_bark, tolerance=1e-3)
  expect_equal(by_package_sp$total_branch_Mg_ha, by_hand_sp$total_branch, tolerance=1e-3)
  expect_equal(by_package_sp$total_ag_Mg_ha, by_hand_sp$total_ag, tolerance=1e-3)
  expect_equal(by_package_sp$merch_total_Mg_ha, by_hand_sp$merch_total, tolerance=1e-3)
  expect_equal(by_package_sp$merch_top_Mg_ha, by_hand_sp$merch_top, tolerance=1e-3)
  expect_equal(by_package_sp$stump_total_Mg_ha, by_hand_sp$stump_total, tolerance=1e-3)
  expect_equal(by_package_sp$foliage_Mg_ha, by_hand_sp$foliage, tolerance=1e-3)

  expect_equal(by_package_sp$total_wood_c, by_hand_sp$total_wood_c, tolerance=1e-3)
  expect_equal(by_package_sp$total_bark_c, by_hand_sp$total_bark_c, tolerance=1e-3)
  expect_equal(by_package_sp$total_branch_c, by_hand_sp$total_branch_c, tolerance=1e-3)
  expect_equal(by_package_sp$total_ag_c, by_hand_sp$total_ag_c, tolerance=1e-3)
  expect_equal(by_package_sp$merch_total_c, by_hand_sp$merch_total_c, tolerance=1e-3)
  expect_equal(by_package_sp$merch_top_c, by_hand_sp$merch_top_c, tolerance=1e-3)
  expect_equal(by_package_sp$stump_total_c, by_hand_sp$stump_total_c, tolerance=1e-3)
  expect_equal(by_package_sp$foliage_c, by_hand_sp$foliage_c, tolerance=1e-3)
...
test_that("Package and hand status summaries match", {
  ...
  expect_warning(expect_warning(by_package_st <- BiomassNSVB(data = nsvb_sum_check, input_units = "metric", output_units = "metric", results = "by_status")$dataframe))
  ...
  expect_equal(by_package_st$total_wood_L_Mg_ha, by_hand_st$total_wood_L, tolerance=1e-3)
  expect_equal(by_package_st$total_wood_D_Mg_ha, by_hand_st$total_wood_D, tolerance=1e-3)
  expect_equal(by_package_st$total_bark_L_Mg_ha, by_hand_st$total_bark_L, tolerance=1e-3)
  expect_equal(by_package_st$total_bark_D_Mg_ha, by_hand_st$total_bark_D, tolerance=1e-3)
  expect_equal(by_package_st$total_branch_L_Mg_ha, by_hand_st$total_branch_L, tolerance=1e-3)
  expect_equal(by_package_st$total_branch_D_Mg_ha, by_hand_st$total_branch_D, tolerance=1e-3)
  expect_equal(by_package_st$total_ag_L_Mg_ha, by_hand_st$total_ag_L, tolerance=1e-3)
  expect_equal(by_package_st$total_ag_D_Mg_ha, by_hand_st$total_ag_D, tolerance=1e-3)
  expect_equal(by_package_st$merch_total_L_Mg_ha, by_hand_st$merch_total_L, tolerance=1e-3)
  expect_equal(by_package_st$merch_total_D_Mg_ha, by_hand_st$merch_total_D, tolerance=1e-3)
  expect_equal(by_package_st$merch_top_L_Mg_ha, by_hand_st$merch_top_L, tolerance=1e-3)
  expect_equal(by_package_st$merch_top_D_Mg_ha, by_hand_st$merch_top_D, tolerance=1e-3)
  expect_equal(by_package_st$stump_total_L_Mg_ha, by_hand_st$stump_total_L, tolerance=1e-3)
  expect_equal(by_package_st$stump_total_D_Mg_ha, by_hand_st$stump_total_D, tolerance=1e-3)
  expect_equal(by_package_st$foliage_L_Mg_ha, by_hand_st$foliage_L, tolerance=1e-3)

  expect_equal(by_package_st$total_wood_L_c, by_hand_st$total_wood_L_c, tolerance=1e-3)
  expect_equal(by_package_st$total_wood_D_c, by_hand_st$total_wood_D_c, tolerance=1e-3)
  expect_equal(by_package_st$total_bark_L_c, by_hand_st$total_bark_L_c, tolerance=1e-3)
  expect_equal(by_package_st$total_bark_D_c, by_hand_st$total_bark_D_c, tolerance=1e-3)
  expect_equal(by_package_st$total_branch_L_c, by_hand_st$total_branch_L_c, tolerance=1e-3)
  expect_equal(by_package_st$total_branch_D_c, by_hand_st$total_branch_D_c, tolerance=1e-3)
  expect_equal(by_package_st$total_ag_L_c, by_hand_st$total_ag_L_c, tolerance=1e-3)
  expect_equal(by_package_st$total_ag_D_c, by_hand_st$total_ag_D_c, tolerance=1e-3)
  expect_equal(by_package_st$merch_total_L_c, by_hand_st$merch_total_L_c, tolerance=1e-3)
  expect_equal(by_package_st$merch_total_D_c, by_hand_st$merch_total_D_c, tolerance=1e-3)
  expect_equal(by_package_st$merch_top_L_c, by_hand_st$merch_top_L_c, tolerance=1e-3)
  expect_equal(by_package_st$merch_top_D_c, by_hand_st$merch_top_D_c, tolerance=1e-3)
  expect_equal(by_package_st$stump_total_L_c, by_hand_st$stump_total_L_c, tolerance=1e-3)
  expect_equal(by_package_st$stump_total_D_c, by_hand_st$stump_total_D_c, tolerance=1e-3)
  expect_equal(by_package_st$foliage_L_c, by_hand_st$foliage_L_c, tolerance=1e-3)
...
test_that("Package and hand plot summaries match", {
  ...
  expect_warning(expect_warning(by_package_plot <- BiomassNSVB(data = nsvb_sum_check, input_units = "metric", output_units = "metric", results = "by_plot")$dataframe))
  ...
  expect_equal(by_package_plot$total_wood_Mg_ha, by_hand_plot$total_wood, tolerance=1e-3)
  expect_equal(by_package_plot$total_bark_Mg_ha, by_hand_plot$total_bark, tolerance=1e-3)
  expect_equal(by_package_plot$total_branch_Mg_ha, by_hand_plot$total_branch, tolerance=1e-3)
  expect_equal(by_package_plot$total_ag_Mg_ha, by_hand_plot$total_ag, tolerance=1e-3)
  expect_equal(by_package_plot$merch_total_Mg_ha, by_hand_plot$merch_total, tolerance=1e-3)
  expect_equal(by_package_plot$merch_top_Mg_ha, by_hand_plot$merch_top, tolerance=1e-3)
  expect_equal(by_package_plot$stump_total_Mg_ha, by_hand_plot$stump_total, tolerance=1e-3)
  expect_equal(by_package_plot$foliage_Mg_ha, by_hand_plot$foliage, tolerance=1e-3)

  expect_equal(by_package_plot$total_wood_c, by_hand_plot$total_wood_c, tolerance=1e-3)
  expect_equal(by_package_plot$total_bark_c, by_hand_plot$total_bark_c, tolerance=1e-3)
  expect_equal(by_package_plot$total_branch_c, by_hand_plot$total_branch_c, tolerance=1e-3)
  expect_equal(by_package_plot$total_ag_c, by_hand_plot$total_ag_c, tolerance=1e-3)
  expect_equal(by_package_plot$merch_total_c, by_hand_plot$merch_total_c, tolerance=1e-3)
  expect_equal(by_package_plot$merch_top_c, by_hand_plot$merch_top_c, tolerance=1e-3)
  expect_equal(by_package_plot$stump_total_c, by_hand_plot$stump_total_c, tolerance=1e-3)
  expect_equal(by_package_plot$foliage_c, by_hand_plot$foliage_c, tolerance=1e-3)
